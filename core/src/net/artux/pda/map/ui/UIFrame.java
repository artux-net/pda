...
public class UIFrame extends Group implements Disposable {
    ...
    private  Color primaryColor = Color.valueOf("#3c3d48");
    private  Color backgroundColor = Color.valueOf("#161719");
    ...
    private Table leftGroup;
    private Table rightGroup;
