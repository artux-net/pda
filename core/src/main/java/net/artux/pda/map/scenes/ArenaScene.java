...
import net.artux.pda.map.utils.UDPClient;
...
public class ArenaScene extends Scene {
    ...
    @Inject
    public ArenaScene(final SceneManager sceneManager, DataRepository dataRepository,
                      ApplicationLogger logger,
                      GameMap gameMap, CoreComponent coreComponent, UDPClient udpClient) {
        super(sceneManager);
        this.logger = logger;
