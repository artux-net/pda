...
public class PdaAlertDialog extends AlertDialog.Builder {
    ...
    public PdaAlertDialog(Context context, ViewGroup root) {
        super(context);
        set(context, root);
    }

    public PdaAlertDialog(Context context, ViewGroup root, int themeResId) {
        super(context, themeResId);
        set(context, root);
    }

    private void set(Context context, ViewGroup root){
        view = LayoutInflater.from(context).inflate(R.layout.dialog_view, root, false);
